...
>
    ...
    <hr>
    <a href="add.html" class="left">发布微博 </a>
...
<?php while($row = mysqli_fetch_assoc($res2)) { ?>
            <h3><img src="标签2-皮卡丘.jpg" width="50" height="70"  align="middle">微博标题：<a href = "disinfo.php?id=<?php echo $row['id'] ?>"><?php echo $row['weiboName'] ?></a>| <a href = "delete2.php?id=<?php echo $row['id'] ?>"> 删除 </a> |</h3>
