...
{
    //更新friend——apply申请状态
    $update_sql = "update friend_apply set apply_status='$apply_status1' where be_apply_user='$be_apply_user' and apply_user='$friend_user' and apply_status='$apply_status0'";
    $update_query = mysqli_query($conn,$update_sql) or die(mysqli_error($conn));
    //插入数据进入friend_list表——我
    ...
    //插入数据进入friend_list表——好友
    $insert_sql2 = "insert into friend_list(my_id,my_user,friend_id,friend_user) values('$friend_id','$friend_user','$my_id','$my_user')";
...
{
    $update_sql = "update friend_apply set apply_status='$apply_status2' where be_apply_user='$be_apply_user' and apply_user='$friend_user' and apply_status='$apply_status0' ";
    $update_query = mysqli_query($conn,$update_sql) or die(mysqli_error($conn));
