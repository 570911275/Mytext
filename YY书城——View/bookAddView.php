...
$imgname = $label->imgname_store;
$_SESSION['imgname_store'] = $imgname;
?>
<html>
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><h2>
<style type="text/css">
...
<div>
<fieldset>
<legend>YY书城——添加图书</legend>
</fieldset>
</div>
<div >
<fieldset>
<form action="bookAddControl.php" method="POST" enctype="multipart/form-data">
    <h4>输入图书名称:</h4>
