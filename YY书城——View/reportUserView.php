...
<div>
<fieldset>
<form  method="POST" action="reportUserControl.php" enctype="multipart/form-data">
    <p>
    <label for="user" class="label">举报用户：</label>
    <input id="user" name="user" type="text" calss="input"/>
    </p>
    <hr/>
    <p>
    <h3>举报内容：</h3>
