...
<head>
    ...
    <style>
        body {font-family:\5B8B\4F53,Arial Narrow,arial,serif;background:#ffffff;font-size:15px; color:#313131;}
        ...
        .modTop em{float:left;padding:6px 10px 0px 80px;font-style:normal;color:#000;}
...
<div class="wrap">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=教材">教材</a></li>
                                        <li><a href="bookVarietyView.php?variety=教辅">教辅</a></li>
                                        <li><a href="bookVarietyView.php?variety=工具书">工具书</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=玄幻奇幻">玄幻奇幻</a></li>
                                        <li><a href="bookVarietyView.php?variety=武侠仙侠">武侠仙侠</a></li>
                                        <li><a href="bookVarietyView.php?variety=军事历史">军事历史</a></li>
                                        <li><a href="bookVarietyView.php?variety=悬疑灵异">悬疑灵异</a></li>
                                        <li><a href="bookVarietyView.php?variety=体育游戏">体育游戏</a></li>
                                        <li><a href="bookVarietyView.php?variety=科幻军事">科幻军事</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=绘本">绘本</a></li>
                                        <li><a href="bookVarietyView.php?variety=科普">科普</a></li>
                                        <li><a href="bookVarietyView.php?variety=百科">百科</a></li>
                                        <li><a href="bookVarietyView.php?variety=卡通">卡通</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=运动保健">运动保健</a></li>
                                        <li><a href="bookVarietyView.php?variety=孕期育儿">孕期育儿</a></li>
                                        <li><a href="bookVarietyView.php?variety=家居风水">家居风水</a></li>
                                        <li><a href="bookVarietyView.php?variety=亲子家教">亲子家教</a></li>
                                        <li><a href="bookVarietyView.php?variety=美食旅游">美食旅游</a></li>
                                        <li><a href="bookVarietyView.php?variety=休闲手工">休闲手工</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=自然科学">自然科学</a></li>
                                        <li><a href="bookVarietyView.php?variety=农林">农林</a></li>
                                        <li><a href="bookVarietyView.php?variety=工业">工业</a></li>
                                        <li><a href="bookVarietyView.php?variety=计算机">计算机</a></li>
                                        <li><a href="bookVarietyView.php?variety=天文">天文</a></li>
                                        <li><a href="bookVarietyView.php?variety=建筑">建筑</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="bookVarietyView.php?variety=文学">文学</a></li>
                                        <li><a href="bookVarietyView.php?variety=艺术">艺术</a></li>
                                        <li><a href="bookVarietyView.php?variety=摄影">摄影</a></li>
                                        <li><a href="bookVarietyView.php?variety=传记">传记</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modTop"><div class="sidetitle"><em>排列方式分类</em></div></div>
        <div class="sidecontent" >
            <div class="my_left_category">
                <div class="my_left_cat_list">
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="priceAscView.php">价格升序</a></li>
                                        <li><a href="priceDescView.php">价格降序</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="timeAscView.php">时间升序</a></li>
                                        <li><a href="timeDescView.php">时间降序</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="praiseAscView.php">好评升序</a></li>
                                        <li><a href="praiseDescView.php">好评降序</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h2_cat" onmouseover="this.className='h2_cat active_cat'" onmouseout="this.className='h2_cat'">
                        ...
                        <div class="h3_cat">
                            <div class="shadow">
                                <div class="shadow_border">
                                    <ul>
                                        <li><a href="salesAscView.php">销量升序</a></li>
                                        <li><a href="salesDescView.php">销量降序</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
