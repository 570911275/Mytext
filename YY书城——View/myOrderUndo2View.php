...
if($label_length==0)
{
  echo "<script>alert('目前，尚无已发货订单');history.go(-1);</script>";
}
?>
...
<?php for($i=0;$i<$label_length;$i++){?>
            ...
            <button type="button"><a href="myOrderUndoControl.php?id=<?php echo $label[$i]->id?>">确认收货</a></button>
            <button type="button"><a href="chatUserView.php?id=<?php echo $label[$i]->bookid?>">联系商家</a></button>
            <hr/>
            <hr/>
<?php }?>
</p>
