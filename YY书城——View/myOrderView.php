...
if($label_length==0)
{
  echo "<script>alert('目前，尚无未付款订单');history.go(-1);</script>";
}
?>
...
<?php for($i=0;$i<$label_length;$i++){?>
            ...
            <button type="button"><a href="payAffirm2View.php?id=<?php echo $label[$i]->id?>">立即购买</a></button>
            <button type="button"><a href="myOrderControl.php">联系商家</a></button>
